...
export const All = () => {
  ...
  return (
    ...
    >
      ...
      <Ekspanderbartpanel apen={open} tittel="Controlled">
        "Controlled" ekspanderbartpanel som styres av knappen, men som også kan
        åpnes og lukkes ved å tykke på header (for å ivareta legacy).
      </Ekspanderbartpanel>
    </div>
  );
};
